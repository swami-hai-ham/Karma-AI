  ...
  return (
    <div className='bg-yellow-500 text-stone-900 font-mono font-bold uppercase p-4 flex-1'>
      <div className="navbar bg-base-300 flex justify-between">
        <div>
          <button className="btn btn-ghost text-xl mx-3 hover:bg-yellow-500 focus:border-b-2 focus:border-b-slate-900 hover:text-stone-700 p-2">Dashboard</button>
          <button className="btn btn-ghost text-xl mx-3 hover:bg-yellow-500 focus:border-b-2 focus:border-b-slate-900 hover:text-stone-700 p-2">Coach</button>
        </div>
        <div>
